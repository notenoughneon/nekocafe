...
const cachedEmbed = widget((update) => {
    console.log('widget');
    ...
    function onUpdate(newSnippet) {
        if (!updated) {
            updated = true;
            console.log('update: ' + newSnippet);
            div.innerHTML = newSnippet;
